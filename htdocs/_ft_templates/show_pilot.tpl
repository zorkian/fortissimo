...
<tr><td colspan='6' class='dateheader'>Pilot Statistics - {$pilot->pilot}</td></tr>

<tr><td rowspan='12' width='256'>{$pilot->pilot_img256()}</td>
...
{assign var=pilotid value=$pilot->pilot_id}
{assign var=title value="Last 10 Kills (<a href='/all_kills.php?type=kill&pilotid=$pilotid&which=k'>Show All</a>)"}
{assign var=killids value=$killids2}
{assign var=kills value=$kills2}
{include file="show_kills_dateless.tpl"}

{assign var=title value="Last 10 Losses (<a href='/all_kills.php?type=loss&pilotid=$pilotid&which=v'>Show All</a>)"}
{assign var=killids value=$lossids}
{assign var=kills value=$losses}
{include file="show_kills_dateless.tpl"}

{assign var=title value="Last 10 Kills (<a href='/all_kills.php?type=loss&pilotid=$pilotid&which=k'>Show All</a>)"}
{assign var=killids value=$xkillids}
{assign var=kills value=$xkills}
{include file="show_kills_dateless.tpl"}

{assign var=title value="Last 10 Losses (<a href='/all_kills.php?type=kill&pilotid=$pilotid&which=v'>Show All</a>)"}
