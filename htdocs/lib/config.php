<?php
    ...
    # this is the path you put all of the Fortissimo files in
    $_APP_PATH = "/web/eve-dev/public_html";

    # the address that this site is located at, WITHOUT a trailing slash!
    $_WEB_URL = "http://www.eve-dev.com/trunk/htdocs";
